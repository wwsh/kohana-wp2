...
define('KWP_DOCROOT', WP_PLUGIN_DIR . '/kohana-wp2/');
...
class KWP_Plugin
{
    ...
    function __construct()
    {
        ...
        if (KWP_IN_ADMIN) {
            ...
            define('KOHANA_APPS_ROOT', WP_CONTENT_DIR . '/kohana/site/');
        }

        define('KOHANA_FIXED_APPS_ROOT', WP_CONTENT_DIR . '/kohana/site/');
    ...
    function run()
    {
        if (KWP_IN_ADMIN) {
            ...
            register_deactivation_hook('kohana-wp2/kohana-wp2.php', 'KWP_Plugin::deactivate');
            register_activation_hook('kohana-wp2/kohana-wp2.php', 'KWP_Plugin::activate');
            KWP_Registration::register_admin_hooks();
        } else {
            KWP_Registration::register_content_hooks();
        }
    }
}
