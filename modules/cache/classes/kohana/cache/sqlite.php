...
class Kohana_Cache_Sqlite extends Cache implements Cache_Tagging, Cache_GarbageCollect
{
    ...
    protected function __construct(array $config)
    {
        ...
        if (0 == count($result)) {
            ...
            try {
                ...
                throw new Cache_Exception('Failed to create new SQLite caches table with the following error : :error',
    ...
    public function get($id, $default = null)
    {
        ...
        try {
            ...
            throw new Cache_Exception('There was a problem querying the local SQLite3 cache. :error',
                                      array(':error' => $e->getMessage()));
        }
    ...
    public function set_with_tags($id, $data, $lifetime = null, array $tags = null)
    {
        ...
        // Setup lifetime
        if ($lifetime === null) {
            $lifetime = (0 === Arr::get($this->_config, 'default_expire', null)) ? 0 : (Arr::get($this->_config,
                                                                                                 'default_expire',
