...
class MustachePragmaDotNotationTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDeepTraversal()
    {
        ...
        $this->assertEquals($m->render('{{%DOT-NOTATION}}{{one.one}}|{{one.two}}|{{one.three}}'),
    ...
    public function testDotNotationContext()
    {
        ...
        $this->assertEquals('12345',
                            $m->render('{{%DOT-NOTATION}}{{#parent}}{{#items}}{{item.index}}{{/items}}{{/parent}}'));
    }
    ...
    public function testDotNotationSectionNames()
    {
        ...
        $this->assertEquals('12345',
                            $m->render('{{%DOT-NOTATION}}{{#parent.items}}{{#item}}{{index}}{{/item}}{{/parent.items}}'));
    }
}