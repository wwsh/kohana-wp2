...
/**
 * This module emulates OAuth for native PD logins.
 ...
 *
 */
class Membership_Provider_PD extends Membership_Provider
{
    ...
    public function verifyLogin()
    {
        ...
        if (empty($result_array['access_token'])) {
            throw new Exception('Invalid response received. Response = "' . $result . '"');
        }
        ...
        if (!is_array($user)) {
            throw new Exception('Invalid user data returned');
        }
