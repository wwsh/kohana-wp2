...
class Kohana_ArrTest extends Unittest_TestCase
{
    ...
    public function provider_extract()
    {
        return array(
            ...
            array(
                ...
                'default',
                // Expected Result
                array('level1a' => array('level2a' => 'value 1'),
                      'level1b' => array('level2b' => 'value 2'),
                      'level1c' => 'default',
                      'level1d' => array('notfound' => 'default')),
            ),
        );
    }
    ...
    public function provider_path()
    {
        $array = array(
            ...
            'users'  => array(
                1 => array('name' => 'matt'),
                2 => array('name' => 'john',
                           'interests' => array('hocky' => array('length' => 2), 'football' => array())),
                3 => 'frank', // Issue #3194
            ),
    ...
    public function provider_map()
    {
        return array(
            ...
            array('strip_tags',
                  array(array('<p>foobar</p>'), array('<p>foobar</p>')),
                  null,
                  array(array('foobar'), array('foobar'))),
            array(
                'strip_tags',
