...
class Kohana_FeedTest extends Unittest_TestCase
{
    ...
    {
        $info = array('pubDate' => 123,
                      'image'   => array('link'  => 'http://kohanaframework.org/image.png',
        ...
        return array(
            // $source, $expected
            array($info,
                  array('foo' => array('foo' => 'bar', 'pubDate' => 123, 'link' => 'foo')),
                  array('_SERVER' => array('HTTP_HOST' => 'localhost') + $_SERVER),
                  array(
                      'tag'        => 'channel',
                      'descendant' => array(
                          'tag'   => 'item',
