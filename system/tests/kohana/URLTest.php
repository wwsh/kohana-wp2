...
class Kohana_URLTest extends Unittest_TestCase
{
    ...
    public function provider_base()
    {
        return array(
            ...
            array(true,
                  ...
                  array('HTTPS' => false, 'Request::$initial' => Request::factory('/')->protocol('cli'))),

            // Change base url'
            array('https',
                  false,
                  'https://example.com/kohana/',
                  array('Kohana::$base_url' => 'omglol://example.com/kohana/')),
            ...
            array('http',
                  ...
                  array('HTTP_HOST' => 'example.com', 'SERVER_NAME' => 'example.org')),

            // Use SERVER_NAME if HTTP_HOST DNX
            array('http',
                  false,
                  'http://example.org/kohana/',
                  array('HTTP_HOST' => null, 'SERVER_NAME' => 'example.org')),
        );
    }
    ...
    public function provider_site()
    {
        return array(
            ...
            array('my/site?var=asd&kohana=awesome',
                  'http',
            ...
            array('?kohana=awesome&life=good#fact',
                  'http',
                  'http://example.com/kohana/index.php/?kohana=awesome&life=good#fact'),

            array('some/long/route/goes/here?kohana=awesome&life=good#fact',
                  null,
            ...
            array('/route/goes/here?kohana=awesome&life=good#fact',
                  'https',
    ...
    public function provider_query()
    {
        return array(
            ...
            // @issue 4240
            array(array('_GET' => array('foo' => array('a' => 100))),
                  '?foo%5Ba%5D=100&foo%5Bb%5D=bar',
                  array('foo' => array('b' => 'bar'))),
