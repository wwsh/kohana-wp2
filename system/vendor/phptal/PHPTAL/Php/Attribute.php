...
abstract class PHPTAL_Php_Attribute
{
    ...
    {
        $this->tag                   = $this->phpelement;
        $this->phpelement->generator = $codewriter;
        $this->start(); // FIXME: remove
    }
    ...
    {
        throw new PHPTAL_Exception('Do not use');
    }
     ...
     * @deprecated
     */
    final public function doEcho($code)
    {
        $this->doEchoAttribute($this->tag->generator, $code);
    }
