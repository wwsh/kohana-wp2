        ...
        foreach ($root->childNodes as $node) {
            ...
            if ($node instanceof PHPTAL_Dom_Text) {
                ...
                if ($node instanceof PHPTAL_Dom_Element) {
                    ...
                    if ($node instanceof PHPTAL_Dom_DocumentType || $node instanceof PHPTAL_Dom_XMLDeclaration) {
                        $this->had_space = true;
                    } else {
                        if ($node instanceof PHPTAL_Dom_ProcessingInstruction) {
